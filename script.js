...
function loadEmployees() {
  ...
  employees.forEach((emp, idx) => {
    ...
    row.ondblclick = () => alert("EK-2 geçmişi özelliği geliştiriliyor.");
...
function saveEK2() {
  ...
  alert("EK-2 işlemi kaydedildi. (Şu an belge oluşturma devre dışı)");
}

// Excel işlemleri (sadece uyarı)
function exportToExcel() {
  alert("Excel'e Aktar özelliği yakında eklenecek.");
}
